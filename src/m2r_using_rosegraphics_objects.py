...
#            with this RoseWindow, then draws all those Shapes. After doing
#            so, pauses the given number of seconds.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            This method call is necessary to prevent the window from closing
#            prematurely. It also provides the program with the rg.Point where
#            the user clicked the window which can be used later.
#

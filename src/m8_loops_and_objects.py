...
def draw_circles1():
    ...
    for x in range(21):
        ...
        note = rg.Circle(center_point, radius)
...
def draw_circles2():
    ...
    for x in range(18):
        circle_center = rg.Point(50 + 20 * x, 100)

        note = rg.Circle(circle_center, radius)
...
def draw_circles3():
    ...
    circle_center = rg.Point(200, 150)
...
def draw_cosines_and_sines():
    ...
    for x in range(101):
        circle_center = rg.Point(200 + (80 * math.cos(x)), 200 + (80 * math.sin(x)))
